"""
Golden Cross Rotation v2 — Trend Entry (Entry B)
=================================================
...
Usage:
  cd backend && ./venv/bin/python ../strategies/golden_cross_v2_trend.py
"""
...
def main():
    ...
    print("=" * 80)
    print("  GOLDEN CROSS ROTATION v2 — TREND ENTRY (Entry A + Entry B)")
    print("=" * 80)
    ...
    for idx, ticker in enumerate(all_tickers):
        ...
        # ── Entry B: Trend ride ─────────────────────────────────────────────
        # Check every day for: Price > EMA50 > EMA200 AND RSI > 60 AND Vol > 1.2× avg
        # Use EMA50 slope as trend strength proxy for scoring
        entry_b_lookback = 5
        for i in range(200, len(df)):  # Need 200 bars for EMA200
